...
using LinuxInvaders.Core.Effects;
using LinuxInvaders.Core.Inputs;
using LinuxInvaders.Core.Localization;
using LinuxInvaders.Core.Settings;
using LinuxInvaders.ScreenManagers;
using Microsoft.Xna.Framework;
using Microsoft.Xna.Framework.Content;
using Microsoft.Xna.Framework.Graphics;

namespace LinuxInvaders.Screens;
...
class MainMenuScreen : MenuScreen
{
    ...
    private SettingsManager<LinuxInvadersSettings> settingsManager;
    ...
    private void SetLanguageText()
    {
        ...
        Title = "LinuxInvaders"; // TODO uncomment this if you want it to use Resources.MainMenu; instead
    }
    ...
    public override void LoadContent()
    {
        ...
        settingsManager ??= ScreenManager.Game.Services.GetService<SettingsManager<LinuxInvadersSettings>>();
